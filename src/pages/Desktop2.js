...
const Desktop2 = () => {
  ...
  return (
    <div className="desktop-2" >
      ...
      <div className="temperature" style={{width:'230px', height:'310px', position:'absolute', zIndex:'2', left:'720px', top:'350px'}}>
      ...
      <div className="bloodpressure" style={{width:'235px', height:'310px', position:'absolute', zIndex:'2', left:'970px', top:'200px'}}>
        <img src={bloodpressure} style={{width:'170px', height:'175px', position:'relative', left:'60px'}}></img>
        <p style={{textAlign:'center', fontSize:'30px', position:'relative', top:'-25px', fontWeight:'bold', color:'black'}}>BLOOD PRESSURE <br/> 120/80 mmHg</p>
      </div>

      <div className="oxygen" style={{width:'280px', height:'310px', position:'absolute', zIndex:'2', left:'1220px', top:'350px'}}>
